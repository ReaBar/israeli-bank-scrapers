...
var base_beinleumi_group_2 = require("./base-beinleumi-group");
var base_beinleumi_group_3 = require("./base-beinleumi-group");
var waiting_1 = require("../helpers/waiting");
var OtsarHahayalScraper = /** @class */ (function (_super) {
    __extends(OtsarHahayalScraper, _super);
    function OtsarHahayalScraper() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.BASE_URL = 'https://online.bankotsar.co.il';
        _this.LOGIN_URL = "".concat(_this.BASE_URL, "/MatafLoginService/MatafLoginServlet?bankId=OTSARPRTAL&site=Private&KODSAFA=HE");
    ...
    OtsarHahayalScraper.prototype.getLoginOptions = function (credentials) {
        var _a;
        var _this = this;
        return {
            loginUrl: "".concat(this.LOGIN_URL),
            fields: (0, base_beinleumi_group_2.createLoginFields)(credentials),
            ...
            postAction: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, (0, base_beinleumi_group_3.waitForPostLogin)(this.page)];
            }); }); },
            possibleResults: (_a = {},
                _a[base_scraper_with_browser_1.LoginResults.Success] = [
                    /otsar.*accountSummary/,
